...
const MyProfile = () => {
  ...
  const {
    ...
    axiosPrivate.get(`https://hidden-harbor-03089.herokuapp.com/user/${user.email}`)
  );
  ...
  const onSubmit = async (data) => {
    ...
    await axiosPrivate
      .put(`https://hidden-harbor-03089.herokuapp.com/users/${user.email}`, updateProfile)
      .then((data) => {
        console.log(data);
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="form-control">
                ...
                <input
                  ...
                  placeholder={userProfile?.data?.displayName}
              ...
              <div className="form-control">
                ...
                <input
                  {...register("education", {
                    required: "Your Education is required",
                  })}
                  type="text"
                  defaultValue={userProfile?.data?.education}
                  placeholder="Your Education lvl"
                  className="input input-bordered"
                />
                <p className="text-red-500">
              ...
              <div className="form-control mt-6">
                <button className="btn  text-white uppercase font-bold btn-secondary">
                  Submit
                </button>
              </div>
            </form>
