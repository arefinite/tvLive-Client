...
const MyReview = () => {
  ...
  const onSubmit = async (data) => {
    ...
    axiosPrivate.post("https://hidden-harbor-03089.herokuapp.com/reviews", reviews).then((data) => {
        ...
        <div className="card-body">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="form-control">
              ...
              <input
                {...register("rating", { required: "Your Rating is required" })}
                type="range"
                min="10"
                max="50"
                defaultValue={50}
            ...
            <div className="form-control mt-6">
              <button
                className={`btn  text-white uppercase font-bold btn-secondary`}
              >
                Submit
              </button>
            </div>
