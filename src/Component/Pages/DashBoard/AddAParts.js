    ...
    fetch(url, {
      ...
      .then((result) => {
        if (result.success) {
          ...
          axiosPrivate
            .post("https://hidden-harbor-03089.herokuapp.com/parts", parts)
            .then((data) => {
    ...
    <div className="card w-96 bg-base-100 shadow-xl">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="form-control">
          ...
          <input
            {...register("name", { required: "Part's Name is required" })}
            type="text"
        ...
        <div className="form-control">
          ...
          <input
            {...register("price", { required: "Part's Price is required" })}
            type="text"
            placeholder="Part's Price"
            className="input input-bordered"
          />
          <p className="text-red-500">{errors.name && errors.name.message}</p>
        </div>
        <div className="form-control">
          ...
          <input
            {...register("available", {
              required: "Part's Available is required",
            })}
            type="text"
            placeholder="Part's Available"
            className="input input-bordered"
          />
          <p className="text-red-500">{errors.name && errors.name.message}</p>
        </div>
        <div className="form-control">
          ...
          <input
            {...register("description", {
              required: "Part's Description is required",
            })}
            type="text"
        ...
        <div className="form-control">
          ...
          <input
            {...register("partsPicture", {
              required: "Part's Picture is required",
            })}
            type="file"
            className="input input-bordered"
          />
